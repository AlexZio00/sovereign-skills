...
이 20개 중 15개 스킬(원래 라이프사이클 세트 + v6.4 거버넌스 신규 스킬 — v6.3 운영 신규 스킬과 v6.5 신규 스킬은 아직 매핑 안 됨)은 25개의 알려진 에이전트 설계 패턴 중 17개를 구현합니다([Gulli 2026](https://books.google.com/books/about/Agentic_Design_Patterns.html?id=QqR20QEACAAJ), [Sairahul 2026](https://x.com/sairahul1/status/2069045570556383464)):
