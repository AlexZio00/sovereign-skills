...
| [eval-leakage-audit](../eval-leakage-audit/) | **Nuevo.** Audita si un eval/métrica/holdout realmente asegura una verdad de referencia externa independiente o es una autoconfirmación circular — taxonomía de 8 patrones. Solo lectura |
