...
El contenido de SKILL.md es markdown universal — funciona con cualquier LLM que lea instrucciones markdown. Copie `SKILL.md` en la ruta de instrucciones de su agente.
